...
if __name__ == '__main__':
    ...
    accuracy = tf.reduce_mean(tf.cast(tf.equal(tf.squeeze(prediction_output), tf.squeeze(y_target)), tf.float32))
    ...
    plt.title('Gaussian SVN Results on Iris Data')
